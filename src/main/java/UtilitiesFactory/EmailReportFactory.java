...
public class EmailReportFactory {
    ...
    private Message setMessage(Message p_message){
        ...
        try {
            p_message.setFrom(new InternetAddress("xxxxxxxxxxxxxx@gmail.com"));
            p_message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(recipients));
            p_message.setSubject("Google Test Execution");
            String messageString = "<head>\n" +
                    ...
                    "</head>\n" +
                    "<body>\n" +
                    "<br><br><h1 style='text-align:center'>Google Test Execution Report</h1>\n" +
                    "<h3 style='text-align:center'>URL: https://www.google.com/</h3>\n" +
                    "<table>\n" +
                    "  <tr>\n" +
                    "    <th>Type</th>\n" +
                    "    <th>Count</th>\n" +
